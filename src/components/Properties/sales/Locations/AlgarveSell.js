...
import algarve from "../../../../images/algarve.svg";
import { FaBed, FaBath, FaHouseDamage } from "react-icons/fa";
import { ImLocation2 } from "react-icons/im";
import { AiOutlineArrowRight } from "react-icons/ai";
// import { Link } from "react-router-dom";
// import LocationPropertiesForSale from "../LocationPropertiesForSell";
import LocationPropertiesForSell from "../LocationPropertiesForSell";
...
const AlgarveSell = () => {
  return (
    <div>
      ...
      {/*container */}
      <section className="md:h-[1200px] h-[1500px] mt-[20px} w-[360px] md:w-[1020px] mx-auto">
        ...
        <main>
          <article className="w-[180px] flex items-center justify-between mt-[50px]">
            ...
            <p className="text-[18px] font-bold text-orange-600">Algarve</p>
          </article>
          {/*grid */}
              ...
              <div className="border-[4px] px-[10px] h-[200px] md:w-[480px] mt-[40px] flex items-center justify-between">
                ...
                <article>
                  <h1 className="font-bold text-[11px] md:text-[16px]">
                    4 bedroom at algarve portugal
                  </h1>
                  <p className="mt-[10px] text-blue-600 font-bold">850, 000</p>
                  {/*inner grid container */}
                  <div className="grid grid-cols-2 gap-[5px] mt-[15px]">
                    {/*inner grid child-1 */}
                    <div className="flex flex-col items-center justify-self-start">
                      <FaBed />
                      <p className="text-[12px]">4beds</p>
                    </div>
                    {/*inner grid child-2 */}
                    <div className="flex flex-col items-center justify-self-start">
                      <FaBath />
                    ...
                    <div className="flex flex-col items-center justify-self-start">
                      <FaHouseDamage />
                      <p className="text-[12px]">178.3 m2</p>
                    </div>
                    {/*inner grid child-4 */}
                    <div className="flex flex-col items-center justify-self-start">
                      <ImLocation2 />
                      <p className="text-[12px]">
                        lagos, <span className="font-bold">algarve</span>
                      </p>
                    </div>
                  </div>
                </article>
